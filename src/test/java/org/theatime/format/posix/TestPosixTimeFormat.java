...
public class TestPosixTimeFormat {
    ...
    @Test
    public void testUpperV() {
        assertFormat("%V", new UpperV(C));
        assertFormat("%0V", new UpperV(new Specification.Context(false, false, 0, -1, '0', '\0', "", 0, 0)));
        assertFormat("%_V", new UpperV(new Specification.Context(false, false, -1, -1, '_', '\0', "", 0, 0)));
        assertFormat("%-V", new UpperV(new Specification.Context(false, false, -1, -1, '-', '\0', "", 0, 0)));
        assertFormat("%3V", new UpperV(new Specification.Context(false, false, 3, -1, '\0', '\0', "", 0, 0)));
    }

    @Test
    public void testUpperW() {
        assertFormat("%W", new UpperW(C));
        assertFormat("%0W", new UpperW(new Specification.Context(false, false, 0, -1, '0', '\0', "", 0, 0)));
        assertFormat("%_W", new UpperW(new Specification.Context(false, false, -1, -1, '_', '\0', "", 0, 0)));
        assertFormat("%-W", new UpperW(new Specification.Context(false, false, -1, -1, '-', '\0', "", 0, 0)));
        assertFormat("%3W", new UpperW(new Specification.Context(false, false, 3, -1, '\0', '\0', "", 0, 0)));
    }
